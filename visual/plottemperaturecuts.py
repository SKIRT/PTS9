...
# DefaultDustTemperatureCutsProbe or PlanarDustTemperatureCutsProbe instances. If this is not the case,
...
def plotDefaultDustTemperatureCuts(simulation, *, outDirPath=None, outFileName=None, outFilePath=None,
    ...
    probes = [ probe for probe in simulation.probes() \
               if probe.type() in ("DefaultDustTemperatureCutsProbe","PlanarDustTemperatureCutsProbe") ]
