...
## \package pts.visual.do.plot_magnetic_fiels_cuts Plot planar cuts through the magnetic field in a SKIRT input model
#
# This script creates vector plots of magnetic field cuts generated by the DefaultMagneticFieldCutsProbe or
# DefaultMagneticFieldCutsProbe in a SKIRT simulation, allowing a visual evaluation of the magnetic field in the
# SKIRT input model.
#
